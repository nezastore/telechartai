...
if __name__ == '__main__':
    try:
        ...
        if not loop.is_running():
            ...
            logger.error("Event loop sudah berjalan dan tidak dapat ditutup dengan bersih.")
            logger.error("Coba hentikan paksa proses Python atau restart lingkungan Anda.")
